...
public class GooglePlaces {
	...
	public PlacesResult searchNearby( Place.Location location, int radius ) {
		return this.searchNearby( location, radius, null );
	}
	
	public PlacesResult searchNearby( Place.Location location, int radius, PlacesQueryOptions options ) {
